...
import { createdProjectComment } from 'redux/action_creators'
      ...
      createComment(
        ...
        .then(response => {
          const updatedProject = {
            ...project,
            comments: [response, ...project.comments],
          }
...
const mapDispatchToProps = dispatch => ({
  createComment: (params, token) =>
    dispatch(async (dispatch, getState, { network }) => {
      const newComment = await requestHandler(network.projects.createComment)({
        params,
        token,
      })
      dispatch(createdProjectComment(newComment))
