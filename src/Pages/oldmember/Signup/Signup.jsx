...
const noOfForms = 4
const registrationStageTitles = ['Company', 'Company representatives']
...
const PresentStageProgressBar = props => (
  <li
    {...props}
    className="progress-stage lg:w-1/2 h-8 flex justify-center items-center lg:bg-purple-dark relative cursor-pointer"
  >
...
const FutureStageProgressBar = props => (
  <li
    {...props}
    className="progress-stage lg:w-1/2 h-8 flex justify-center items-center lg:bg-pink-lighter border-r border-pink-lighter border-solid text-pink-light relative cursor-pointer"
  >
