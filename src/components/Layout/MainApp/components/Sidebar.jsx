...
const Sidebar = ({ history, logOut }) => (
  <aside className="lg:flex lg:flex-col lg:justify-between lg:sidebar lg:w-1/4 lg:h-full overflow-hidden border-r border-solid border-grey-lighter bg-pink-lightest">
    <MainNav />
