...
class Payment extends Component {
  ...
  unsubscribe = (params, token) => {
    ...
    return requestHandler(network.payment.unsubscribeDue)({ params, token })
      .then(() => Promise.resolve(this.stateSetLoading(false)))
            ...
            <div className="p-4 lg:flex items-center text-grey-darker border-b border-grey-lighter">
              ...
              <div className="w-1/3 ">
                <ButtonFixedWidthRadiusXS
                  onClick={() => this.unsubscribe({ id: user.id }, auth.token)}
                  loading={loading}
