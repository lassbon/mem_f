...
const MyFriendRequests = ({ friendRequest: { companyName, companyPhone, email, membershipPlan, profileImage } }) => {
  return (
    <li className="px-8 py-6 pb-4 border-b border-grey-lighter bg-yellow-lightest">
      <figure className="">
